...
public class Activator implements BundleActivator {
	...
	public void start(BundleContext context) throws Exception {//Start life cycle method
        ...
        System.out.println("           3. List Of Supplier liquor items");
        System.out.println("           4. Search  available liquor by item name");
		...
		if (selection == 1) {//Handles the adding process of new items to the list
			do {
			System.out.println("Enter the New Supplier Liquor Name: ");
			String liquorName = input.nextLine();

			System.out.println("Enter the Supplier Liquor Price: ");
			...
			do {
				...
				System.out.println("-----------------------------------Liquor Item list--------------------------------------------");
