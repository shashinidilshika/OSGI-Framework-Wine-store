        ...
        do {
            ...
            if (selection == 1) {
                ...
                do {
                    ...
                    //System.out.println("Item ID:"+"\t\t" +"Item Name:"+"\t\t" + "Item Price:"+"\t");
                    System.out.println("Item ID :"+"\t" +"Item Name :"+"\t"+"\t" +"Item Price :"+"\t" );
                    //System.out.println("\t\t\t\t Item Name	\t\t\t\t"	+    "Item Price(Rs.)");
                  ...
                  System.out.println();
                  do {
                      System.out.println("\n Enter the Liquor name or item number you need : ");
                  ...
                  if(Amount >= 150000) {
					...
					System.out.println("");
					System.out.println("-------------------------------------------");
					System.out.println("    Item Name       	    : " + LiquoritemID);
					System.out.println("    Number of items	        : " + LiquorQuantity);
