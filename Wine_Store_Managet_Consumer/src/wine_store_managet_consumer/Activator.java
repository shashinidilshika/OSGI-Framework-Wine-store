...
public class Activator implements BundleActivator {
	...
	public void start(BundleContext context) throws Exception {//Start life cycle method
		...
		if (selection == 1) {//Handles the adding process of new items to the list
			...
			System.out.println("Enter The Type Of the liqur item..");
			...
			do {
			System.out.println("Enter the liquor Type you need to remove..:");
			...
			do {
				...
				System.out.println("Quantity:"+"\t" +"Price:"+"\t"+"\t" +"liquorType:"+"\t"+"\t" +"Total Value:"+"\t" );
